...
class CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const GigglesCartScreenContent(), // Replace with your actual content
    );
  }
}

class GigglesCartScreenContent extends StatefulWidget {
  // final int navBarIndex;

  const GigglesCartScreenContent({Key? key,}) : super(key: key);

  @override
  State<GigglesCartScreenContent> createState() => GigglesCartScreenContentState();
}

class GigglesCartScreenContentState extends State<GigglesCartScreenContent> {
